    ...
    return (
        <div className="duration-300 origin-right ease-in-out transition-all opacity-0 group-hover:opacity-100 absolute bottom-12 group-hover:z-20 right-0 space-y-1.5 translate-x-[100px] group-hover:translate-x-0">
            <IconButton
                    ...
                    toast({
                        ...
                        description: (
                            <h6 className="text-tertiary">
                                ...
                                {isWishList ? "removed" : "added"} to your
                                Wishlist
                            </h6>
                        ),
                    });
                ...
                size={14}
                className="group shadow bg-gray-50 hover:bg-white backdrop:inset-0 hover:backdrop:bg-white inset-1 text-secondary hover:text-red-500"
            ...
            <IconButton
                ...
                size={16}
                className="group shadow bg-gray-50 hover:bg-white backdrop:inset-0 hover:backdrop:bg-white inset-1 text-secondary hover:text-primary/70"
                Icon={CiShuffle}
            />
        </div>
    );
